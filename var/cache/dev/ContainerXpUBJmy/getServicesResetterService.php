...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['fos_rest.view_handler'])) + (int) (isset($this->privates['http_exception_listener'])) + (int) (isset($this->services['session'])) + (int) (isset($this->privates['debug.stopwatch']));
}), ['fos_rest.view_handler.default' => 'reset', 'http_exception_listener' => 'reset', 'session' => 'save', 'debug.stopwatch' => 'reset']);
