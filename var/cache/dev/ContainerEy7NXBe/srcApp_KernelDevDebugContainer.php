...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\admin\\ArticleController' => 'getArticleControllerService.php',
            'App\\Controller\\admin\\TagsController' => 'getTagsControllerService.php',
            'App\\Controller\\admin\\UserController' => 'getUserControllerService.php',
            'App\\Controller\\api\\ArticleController' => 'getArticleController2Service.php',
            'App\\Controller\\web\\AdminController' => 'getAdminControllerService.php',
            'App\\Controller\\web\\ArticleController' => 'getArticleController3Service.php',
            'App\\Lib\\Controller\\AdminBaseController' => 'getAdminBaseControllerService.php',
    ...
    protected function getFosRest_FormatListenerService()
    {
        ...
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/web', NULL, NULL, NULL, []), ['prefer_extension' => '2.0', 'fallback_format' => 'json', 'priorities' => [0 => 'html'], 'methods' => NULL, 'attributes' => [], 'stop' => false]);
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin', NULL, NULL, NULL, []), ['prefer_extension' => '2.0', 'fallback_format' => 'json', 'priorities' => [0 => 'json'], 'methods' => NULL, 'attributes' => [], 'stop' => false]);
        ...
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, []), ['prefer_extension' => '2.0', 'fallback_format' => 'json', 'priorities' => [0 => 'html'], 'methods' => NULL, 'attributes' => [], 'stop' => false]);
