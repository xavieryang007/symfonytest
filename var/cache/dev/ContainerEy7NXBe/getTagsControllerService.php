...
// Returns the public 'App\Controller\admin\TagsController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Controller/admin/TagsController.php';
include_once $this->targetDirs[3].'/src/Service/Auth.php';

return $this->services['App\Controller\admin\TagsController'] = new \App\Controller\admin\TagsController(($this->privates['App\Service\Auth'] ?? ($this->privates['App\Service\Auth'] = new \App\Service\Auth())));
